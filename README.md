...
| **Consistency** | Is the data logical and aligned across tables? (Focus on Dates & Foreign Keys) | Validated referential integrity (FKs). Confirmed logical date sequences (purchase → approval → shipment → delivery). Only 1 record had an illogical date sequence; it was excluded. |
